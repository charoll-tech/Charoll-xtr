const {
  ...
  const ownerNumber = ['254103055840']
...
const sessdata = config.SESSION_ID.replace("CHAROL;;;", '');
...
const port = process.env.PORT || 9090;
  ...
  console.log("CHAROL BOT STARTED....🥰");
...
conn.ev.on('connection.update', (update) => {
  ...
  console.log('✅charol xtr started'✅)
